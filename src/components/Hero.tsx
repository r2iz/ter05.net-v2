...
export default function Hero() {
    return (
        ...
        >
            <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-12 w-full md:w-1/2 px-4 md:px-32">
                <motion.div
            ...
            <div className="w-full md:w-1/2 h-full absolute top-0 right-0 flex items-center justify-center blur-3xl mt-12 md:mt-0 hidden md:flex">
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 0.6 }}
